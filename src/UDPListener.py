...
class UDPListener:
    ...
    def handleMessage(self, data: bytes, address: str, activeServerPort: int) -> None:  # type: ignore # createNewServerCallback is a function is a function. No typing module in micropython to specify "Callable"
